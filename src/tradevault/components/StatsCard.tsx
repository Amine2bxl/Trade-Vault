  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-1.5 mb-2">
        ...
        <span className="text-[9px] md:text-[10px] font-semibold text-slate-500 uppercase tracking-wider truncate">
          {title}
        </span>
      </div>
      <div
      ...
      {subtitle && (
        <p className="relative text-[9px] md:text-[10px] text-slate-500 mt-1 truncate">
          {subtitle}
        </p>
      )}
    </div>
