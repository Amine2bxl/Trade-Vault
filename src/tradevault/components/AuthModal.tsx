        ...
        <div className="glass-strong rounded-3xl p-6 md:p-8 shadow-2xl shadow-black/40">
          ...
          <div>
            <button
              onClick={handleOAuth}
              disabled={loading}
              className="flex w-full items-center justify-center gap-2.5 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] py-3 rounded-xl text-sm font-medium text-slate-300 transition-all"
            >
