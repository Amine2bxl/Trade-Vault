...
const fr: Dict = {
  ...
  "rt.premiumBenefit": "Rejoue n'importe quelle séance NQ historique, passe tes ordres en direct, et ramène tes trades dans ton journal.",
  ...
  "rt.noReplayAccount": "Le Backtest est réservé aux abonnés Premium et tourne sur un compte de rejeu dédié : tes statistiques réelles ne sont jamais mélangées à la pratique.",
