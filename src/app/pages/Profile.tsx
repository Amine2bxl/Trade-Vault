...
export default function Profile({ trades }: ProfileProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-6">
      <div className="relative rounded-3xl p-4 sm:p-6 overflow-hidden border border-cyan-500/15 bg-gradient-to-br from-cyan-500/[0.08] via-white/[0.02] to-transparent animate-fade-in-up">
